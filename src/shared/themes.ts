...
const cyberpunkNeon: ThemePalette = {
  ...
  accent: '#00fff5', cursorBg: '#00fff5', cursorFg: '#000000', headerColor: '#ff2e97',
...
const tokyoNight: ThemePalette = {
  ...
  accent: '#7aa2f7', cursorBg: '#7aa2f7', cursorFg: '#1a1b26', headerColor: '#bb9af7',
...
const nordFrost: ThemePalette = {
  ...
  accent: '#88c0d0', cursorBg: '#88c0d0', cursorFg: '#2e3440', headerColor: '#81a1c1',
...
const dracula: ThemePalette = {
  ...
  accent: '#bd93f9', cursorBg: '#bd93f9', cursorFg: '#282a36', headerColor: '#ff79c6',
...
const gruvboxDark: ThemePalette = {
  ...
  accent: '#fe8019', cursorBg: '#fe8019', cursorFg: '#282828', headerColor: '#fabd2f',
...
const rosePine: ThemePalette = {
  ...
  accent: '#c4a7e7', cursorBg: '#c4a7e7', cursorFg: '#191724', headerColor: '#f6c177',
...
const kanagawa: ThemePalette = {
  ...
  accent: '#7e9cd8', cursorBg: '#7e9cd8', cursorFg: '#1f1f28', headerColor: '#957fb8',
...
const everforest: ThemePalette = {
  ...
  accent: '#a7c080', cursorBg: '#a7c080', cursorFg: '#2d353b', headerColor: '#a7c080',
...
const solarizedDark: ThemePalette = {
  ...
  accent: '#268bd2', cursorBg: '#268bd2', cursorFg: '#002b36', headerColor: '#2aa198',
...
const ansiPure: ThemePalette = {
  ...
  accent: 'cyan', cursorBg: 'cyan', cursorFg: 'black', headerColor: 'cyan',
